...
with open('exploratory_analysis.csv', mode='w') as explore_file:
    writer = csv.writer(explore_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(['# of unique users', '# of unique languages', 'total # of mentions', 'average mentions/tweet', '# of tweets with mentions', 'total # of urls', 'average urls/tweet', '# of tweets with urls', '# of tweet with photots', '# of tweet with replies', '# of tweet with retweets', '# of tweet with likes', '# of tweet with hashtags'])
